...
class PlantInstanceListPage(BasePage):
    ...
    #: `wait_for_search_applied`/`wait_for_row_identity` first, which wait for
    #: a *new* thing rather than for "something, anything". Every search
    #: call site in this suite already does that (see `_journey_helpers.py`,
    #: `test_req001_plant_instance.py`).
