...
requirement: UI-NFR-015
title: HA Lovelace Custom Cards
type: ui-nfr
spec_path: spec/ui-nfr/UI-NFR-015_HA-Lovelace-Custom-Cards.md
coverage_score: n/a
status: idee
priority: none
effort: S
...
## Kontext
- **Spec**: `spec/ui-nfr/UI-NFR-015_HA-Lovelace-Custom-Cards.md`
- **Coverage**: n/a
- **Status**: Idee
...
2. `/req-coverage-audit UI-NFR-015` zur Verifikation nach jedem groesseren Block
