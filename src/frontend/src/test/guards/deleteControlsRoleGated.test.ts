...
const NOT_LEAD_ONLY: Record<string, string> = {
  ...
  deleteImportJob: 'imports/router.py — NO role gate at all backend-side; gating the UI would remove a call the API accepts (backend gap, tracked separately)',
  deletePhaseDefinition: 'phase_sequences/router.py — only get_current_user; no role gate backend-side (backend gap, tracked separately)',
  deletePhaseSequence: 'phase_sequences/router.py — only get_current_user (backend gap, tracked separately)',
  deleteSequenceEntry: 'phase_sequences/router.py — only get_current_user (backend gap, tracked separately)',
  deletePest: 'ipm/router.py — global catalogue, no role gate backend-side (backend gap, tracked separately)',
  deleteDisease: 'ipm/router.py — global catalogue, no role gate backend-side (backend gap, tracked separately)',
  deleteTreatment: 'ipm/router.py — global catalogue, no role gate backend-side (backend gap, tracked separately)',
