...
The rules 1, 2 (with the per-test reader rule of #1749), 3 and 5 above hold
the COMMITTED manifests against the LIVE workflows. A pull request that changes a job can only satisfy them with a
