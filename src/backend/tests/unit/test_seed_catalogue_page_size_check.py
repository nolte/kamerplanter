...
class TestCounting:
    ...
    def test_rows_are_deduplicated_across_files_by_identity(self, tree: Tree) -> None:
        ...
        # contract was a raw substring test. Found twice independently — the
        # #1568 review (SCR-005) and the #1456 strand — which is why the repair
        # is the fixture and not the assertion.
        tree.frontend_module("slice.ts", "export const list = () => listAllWidgets();")
