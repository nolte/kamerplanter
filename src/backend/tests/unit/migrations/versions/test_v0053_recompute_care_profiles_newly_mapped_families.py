"""Tests for v0053_recompute_care_profiles_newly_mapped_families (#1505).
...
from app.migrations.versions import v0053_recompute_care_profiles_newly_mapped_families as v0053
from app.migrations.versions.v0053_recompute_care_profiles_newly_mapped_families import (
...
class TestTheDriftGuard:
    ...
    def test_a_moved_fallback_refuses_the_run_instead_of_sweeping_it(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(v0053, "_PRE_1505_TROPICAL_FALLBACK", moved)
        db = _db(families=_family(NEWLY_MAPPED_FAMILY))
    ...
    def test_a_moved_guide_overlay_refuses_the_run_too(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(v0053, "_PRE_1505_TROPICAL_FALLBACK_WITH_GUIDE", moved)
        db = _db(families=_family(NEWLY_MAPPED_FAMILY))
...
class TestTheFrameworkContract:
    def test_it_is_the_fifty_third_migration(self) -> None:
        assert migration.version == "0053"
