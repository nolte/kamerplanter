...
from app.common.auth import get_authenticated_with_api_key, get_current_user, refuse_in_light_mode
...
def get_profile(
    ...
    return UserProfileResponse(
        **profile.model_dump(),
        is_platform_admin=_is_platform_admin(tenant_service, current_user.key or ""),
    )
