...
class ArangoLocationTypeRepository(BaseArangoRepository[LocationType], ILocationTypeRepository):
    _model_cls = LocationType

    def __init__(self, db: StandardDatabase) -> None:
        super().__init__(db, col.LOCATION_TYPES)
