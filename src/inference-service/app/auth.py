...
The inference-service is a cluster-internal M2M microservice (ClusterIP, not
...
# Only the container probes (/health, /ready) are exempt; the pest readiness and
# status routes are backend-driven and carry the token.
