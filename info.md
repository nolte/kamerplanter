...
3. Add `https://github.com/nolte/kamerplanter` with category **Integration**
4. Search for **Kamerplanter** and click **Download**
5. Restart Home Assistant

### Manual

1. Download `kamerplanter-ha.zip` from the [latest release](https://github.com/nolte/kamerplanter/releases/latest)
...
- [Issues](https://github.com/nolte/kamerplanter/issues)
- [Releases](https://github.com/nolte/kamerplanter/releases)
