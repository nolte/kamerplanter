...
The HA custom component lives under `custom_components/kamerplanter/`. It is **not** automatically deployed by Skaffold, as it must be copied into the HA pod:
...
# 3. Restart HA process (NOT kubectl delete pod!)
