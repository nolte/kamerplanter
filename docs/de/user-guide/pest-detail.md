...
Die Detailseite erreichst du über die **Schädlings-Liste** (Navigation: Pflanzenschutz → Schädlinge → Zeile anklicken) oder über den Link **Mehr über diesen Schädling** im [Schädlingserkennungs-Dialog](pest-detection.md), nachdem die automatische Erkennung einen Treffer geliefert hat.
...
!!! tip "Schweregrad richtig einordnen"
...
Das [integrierte Pflanzenschutzmanagement (IPM)](pest-management.md) ordnet Maßnahmen nach dem Prinzip: erst vermeiden, dann beobachten, zuletzt eingreifen — und dabei so sanft wie möglich.
...
- **Nützlinge** (z. B. Raubmilben gegen Spinnmilben, Schlupfwespen gegen Trauermücken) — sie erscheinen auch im Abschnitt [Passende Nützlinge](#passende-nuetzlinge) weiter unten
...
!!! warning "Biologisch heißt nicht harmlos"
    Biologische Mittel tragen eine Karenzzeit (Pre-Harvest Interval, PHI), auch wenn sie meist kürzer ist als bei chemischen Mitteln. Trag die Behandlung immer im [IPM-System](pest-management.md) ein, damit Kamerplanter die Karenzzeit überwacht.
...
!!! danger "Chemische Mittel immer als letzten Ausweg"
...
- Halte die **Mischfolge / Wirkstoff-Rotation** ein: Kamerplanter warnt dich, wenn du denselben Wirkstoff zu häufig einsetzt (Resistenzmanagement, details im [IPM-System](pest-management.md))
...
## Passende Nützlinge {#passende-nuetzlinge}
...
!!! warning "Vor Nützlingsfreisetzung keine Spritzungen"
...
Regelmäßige Inspektionen sind die beste Früherkennung. Kamerplanter generiert automatisch Inspektionsaufgaben — du kannst darüber hinaus jederzeit manuell eine [Befallskontrolle anlegen](pest-management.md).

!!! tip "Schädlingserkennungs-Scan als Ergänzung"
    Die [Schädlingserkennung per Foto](pest-detection.md) ist kein Ersatz für die eigene Sichtprüfung, aber ein nützlicher erster Hinweis. Nutze sie als Ergänzung zu deiner Routinekontrolle — besonders wenn du an einem Blatt etwas Ungewöhnliches siehst.
...
??? question "Woher stammen die Referenzbilder in der Galerie?"
...
??? question "Was ist der Unterschied zwischen einem chemischen und einem biologischen Mittel?"
...
??? question "Warum sehe ich manche Gegenmaßnahmen nicht?"
...
??? question "Die Galerie ist leer — ist das ein Fehler?"
...
??? question "Kann ich selbst Referenzbilder hochladen?"
    Das Hinzufügen von Referenzbildern ist dem Platform-Admin vorbehalten. Als regulärer Nutzer kannst du aber über die [Pflanzenfoto-Galerie](plant-photos.md) Fotos zu deinen eigenen Pflanzen speichern.

??? question "Was bedeutet „Karenzzeit" genau?"
