...
Nach Ablauf einer Sperre wird genau ein weiterer Versuch geprüft; schlägt er fehl, sperrt er sofort wieder mit doppelter Dauer (wie beim Login). Anfragen, die gleichzeitig über das Budget hinaus reserviert haben, werden ohne Passwortprüfung abgewiesen und geben ihre Reservierung zurück. Die Zähler gelten für alle Step-up-Aktionen eines Kontos gemeinsam (kein Budget je Route). Ein erfolgreicher Step-up leert beide. Im Light-Modus wird keine Kontolöschung per Anfrage angenommen (403) — dort ist jede Anfrage das eine Systemkonto.
