...
4. **Bildquelle Webcam und Smartphone** (Nutzer-Anforderung): Die Identifikation bietet beide Erfassungswege an. Die Ausführung steht seit 2026-08-16 in **[REQ-052](REQ-052_Bilderfassung.md) §2** — Live-Kamera (`getUserMedia`, Desktop/Kiosk), Gerätekamera (`capture="environment"`, Smartphone) und Datei-Upload/Drag&Drop; erfasste Bilder werden vor dem Versand nach dem Profil `recognition` normalisiert (1280 px / 0.85, REQ-052 §3) und clientseitig EXIF-gestript (REQ-052 §5). Diese Festlegung bleibt hier verbindlich; REQ-052 ist ihre Umsetzung, nicht ihre Ablösung.
