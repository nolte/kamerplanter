...
| `list_diary_entries` | Tagebuch-Eintraege durchsehen — filterbar nach Pflanze, Art, Eintragstyp, Tag, Analyse-Zustand und Zeitraum. Liefert je Zeile Titel, Tags und **`measurements`**, aber **keinen** Freitext (§7.3 REQ-050: dafuer `get_diary_entry`) und kennt bewusst keine Volltextsuche | `plant_diary_service.list_overview` |
